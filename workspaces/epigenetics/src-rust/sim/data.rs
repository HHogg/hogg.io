...
impl Data {
  ...
  pub fn create(device: &wgpu::Device, config: &sim::Config, width: u32, height: u32) -> Self {
    ...
    let uniforms = Uniforms {
      ...
      partnership_opportunities_max: config.partnership_opportunities_max,
      partnership_fitness_amplification: config.partnership_fitness_amplification,
      partnership_monogamy_amplification: config.partnership_monogamy_amplification,
      genotype_size: config.genotype_size,
      phenotype_size: config.phenotype_size,
      epistasis_enabled: config.epistasis_enabled as u32,
      epistasis_gain: config.epistasis_gain,
      phenotype_gain: config.phenotype_gain,
      regional_env_enabled: config.regional_env_enabled as u32,
      ...
      global_env_enabled: config.global_env_enabled as u32,
