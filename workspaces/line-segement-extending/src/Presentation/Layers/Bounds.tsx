...
export default function Bounds() {
  ...
  const isLineIntersecting = (line: BoundingLine): boolean => {
    if (line.y1 === line.y2) {
      return (
        extendedLineSegmentToBounds.p1.y === line.y1 ||
        extendedLineSegmentToBounds.p2.y === line.y1 ||
        extendedLineSegmentToBounds.p1.y === line.y2 ||
        extendedLineSegmentToBounds.p2.y === line.y2
      );
    }

    if (line.x1 === line.x2) {
      return (
        extendedLineSegmentToBounds.p1.x === line.x1 ||
        extendedLineSegmentToBounds.p2.x === line.x1 ||
        extendedLineSegmentToBounds.p1.x === line.x2 ||
        extendedLineSegmentToBounds.p2.x === line.x2
      );
    }
